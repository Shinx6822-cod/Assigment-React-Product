      ...
      <div>
        <form className="row g-3" onClick ={handleSubmit}>
          <div className="col-md-6">
            <label For="inputName" className="form-label">Name Product</label>
          ...
          <div className="col-md-6">
            ...
            <input value={image} onChange={handleImage} type="name" className="form-control" id="inputImage" />
          </div>
          <div className="col-md-6">
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form className="row g-3" onClick={handleEdit}>
                  <div className="col-md-6">
                    <label For="inputName" className="form-label">Name Product</label>
                    <input
                      value={nameEdit}
